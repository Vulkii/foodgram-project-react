# Generated by Django 3.2.3 on 2024-03-03 10:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='reviews/images/', verbose_name='Ссылка на картинку на сайте')),
                ('text', models.TextField(verbose_name='Описание')),
                ('cooking_time', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, message='Минимальное значение времени приготовления - 1')], verbose_name='Время приготовления')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=200, unique=True, validators=[django.core.validators.RegexValidator(message='В введенном тексте есть запрещенные символы!', regex='^[-a-zA-Z0-9_]{0,200}$')], verbose_name='Уникальный слаг')),
            ],
            options={
                'verbose_name': 'Тег',
